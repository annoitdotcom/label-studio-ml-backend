...
from backbones.coord_conv import CoordConv
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dcn=None):
        ...
        if not self.with_dcn or fallback_on_stride:
            ...
            if not self.with_modulated_dcn:
                ...
                # from modulated_deform_conv import DeformConv2d as DeformConv
                ...
                from backbones.deform_conv_v2 import \
                    DeformConv2d as ModulatedDeformConv
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000,
        ...
        # c_in = 6 if using coord_conv else 3
