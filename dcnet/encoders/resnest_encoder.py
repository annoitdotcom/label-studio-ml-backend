...
from dcnet.modules.splat import SplAtConv2d
...
class ResnestEncoder(EncoderBase):
    """ An encoder for image embedding
    """

    def __init__(self, input_channel, linear_attention, **kwargs):
        super(ResnestEncoder, self).__init__()

        self.encoder = ResNest(
            Bottleneck,
            layers=[3, 4, 6, 3],
